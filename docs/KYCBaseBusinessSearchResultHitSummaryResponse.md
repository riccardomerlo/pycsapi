...
**name** | **object** | The name associated to the search hit. | [optional] 
**match** | **object** | The match string associated to the search hit. | [optional] 
...
**decision** | **str** | The decision made on the search hit. Available values are undecided, trueMatch, falsePositive, discarded. | [optional] 
**note** | **object** | The note added to the search hit. | [optional] 
**modified_by_id** | **int** | The search hit last modified by user id. | [optional] 
**modified_by** | **object** | The search hit last modified by user name. | [optional] 
